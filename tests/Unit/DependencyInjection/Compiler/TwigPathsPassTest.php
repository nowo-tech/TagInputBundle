...
namespace Nowo\TagInputBundle\Tests\Unit\DependencyInjection\Compiler;
...
/**
 * @covers \Nowo\TagInputBundle\DependencyInjection\Compiler\TwigPathsPass
 */
final class TwigPathsPassTest extends TestCase
{
    public function testProcessAddsViewsPathWhenNativeLoaderAliasExists(): void
    {
        ...
        self::assertSame(
            [dirname(__DIR__, 4) . '/src/Resources/views', 'NowoTagInputBundle'],
            $calls[0][1],
        );
    }
